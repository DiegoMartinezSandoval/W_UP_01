...
Our p-value is 0.000009421. Our df value is 27.079. Our t value is -5.4341. Our alternative hypothesis is shown. It states 'true differences in means between group LINE and group SKILL is not equal to 0. Our sample estimates are: mean in group LINE is 17.12500;mean in group SKILL is 49.72 If our null hypothesis is true, the p value is the probability of getting our results. LINE vs SKILL. It is very rare. The p-value is so small we would reject (ignore) the null hypothesis. If it's greater than .05, you failed to reject the null hypotheses (that's bad). If I reject the null hypotheses, I am 95% sure the SKILL group can do more push-ups
